...
/**
 * Brute forces the Farey sequence of size n. These are all fractions
...
function getFareyNeighbors(numerator, denominator, n) {
    let neighbors = {};
...
function fareyApproximation(realNum, n) {
...
console.log(fareyApproximation(Math.PI, 10000));